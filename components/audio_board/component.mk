...
ifdef CONFIG_ESP32_S2_KALUGA_1_V1_3_BOARD
COMPONENT_ADD_INCLUDEDIRS += ./esp32_s2_kaluga_1_v1_3
COMPONENT_SRCDIRS += ./esp32_s2_kaluga_1_v1_3
endif

ifdef CONFIG_ESP32_AITHINKER_A1S_BOARD
COMPONENT_ADD_INCLUDEDIRS += ./aithinker_a1s
COMPONENT_SRCDIRS += ./aithinker_a1s
endif
